...
<head>
    ...
    <script language="javascript">
        ...
        function addFun() {
            top.showTopDialog("新增页面", "${ctx}/manager/addManagerPage.do", "600", "220", "no");
        }
        ...
        function updatepwdFun() {
            ...
            if (rows!="") {
                if(rows.length>1){
                    ...
                    top.showTopDialog("编辑页面", "${ctx}/manager/updatePwdPage.do?id=" + rows[0].id, "600", "220","no");
                }
            } else {
                top.$.messager.alert("信息提示框", "必须选中某一行！");
            }
