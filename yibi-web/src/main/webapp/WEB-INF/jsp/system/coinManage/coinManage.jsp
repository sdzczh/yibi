...
<script language="javascript">
	...
	$(function() {
		...
		dataGrid = $("#dataGrid").datagrid({
			url : "${ctx}/coinManage/getCoinList.do",
			striped : true,
			singleSelect:true,
			rownumbers : true,
            pagination:true,
	...
	function addFun() {
		top.showTopDialog("新增页面", "${ctx}/coinManage/saveOrUpdateCoinPage.do", "1000", "620","yes");
	}
	...
	function updateFun() {
		...
		if (rows!="") {
			if(rows.length>1){
				...
				top.showTopDialog("编辑页面", "${ctx}/coinManage/saveOrUpdateCoinPage.do?id=" + rows[0].id, "1000", "620","yes");
			}
		} else {
