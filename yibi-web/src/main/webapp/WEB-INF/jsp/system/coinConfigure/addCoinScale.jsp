...
<body>
<form id="dataForm" method="post" action="${ctx}/coin/addCoinScale.do">
	<table class="grid">
		<tr>
			<td>交易币种</td>
			<td>
		...
		<tr>
			<td>交易价格、总金额小数位数</td>
			<td>
				<input type="text" name="orderamtpricescale" placeholder="输入位数（整数）" value="" class="enumberbox" data-options="required:true" style="width: 180px;"/>
			</td>
		...
		<tr>
			<td>交易量小数位数</td>
			<td>
				<input type="text" name="orderamtamountscale" value="" class="enumberbox" placeholder="输入位数（整数）" data-options="required:true" style="width: 180px;"/>
			</td>
			<td>提现最小位数</td>
			<td>
				<input type="text" name="withdrawScale" value="" class="enumberbox" placeholder="输入位数（整数）" data-options="required:true" style="width: 180px;"/>
			</td>
		</tr>
		<tr>
			<td>市价买入最低金额</td>
