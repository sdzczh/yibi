    ...
    function updateFun() {
        ...
        if (rows!="") {
            if(rows.length>1){
                ...
                top.showTopDialog("编辑页面", "${ctx}/user/updateAccountPage.do?id=" + rows[0].id, "600", "220","no");
            }
        } else {
...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div id="toolbar" style="display: none;">
		<a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'" onclick="updateFun()">修改钱包可用数量</a>
	</div>
